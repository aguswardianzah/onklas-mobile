...
import id.onklas.app.databinding.IncomePageBinding
...
class IncomePage : Privatepage() {

    private val binding by lazy { IncomePageBinding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.apply {
            ...
            binding.toolbar.title = "Total Pendapatan"
        }

        binding.btnJasa.setOnClickListener {
            navController.popBackStack()
            navController.navigate(R.id.action_global_income_service)
        ...
        binding.btnProduk.setOnClickListener {
            navController.popBackStack()
            navController.navigate(R.id.action_global_income_product)
    ...
    private fun refreshDataList(page: String = "") {
        ...
        lifecycleScope.launch { viewmodelOrder.fetchListSellerOrder(0, "incoming", "seller", "") }
        viewmodelOrder.listIncome("complete", "seller", "ACCEPTED", "")
    }
}