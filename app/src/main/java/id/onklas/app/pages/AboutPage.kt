...
class AboutPage : Privatepage() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.apply {
            ...
            title = "Tentang Kami"
            binding.toolbar.title = "Tentang Kami"
        }
        ...
        lifecycleScope.launchWhenCreated {
            ...
            try {
                binding.webview.loadData(
                    sosmedViewModel.apiService.about(sosmedViewModel.pref.getInt("user_id")).data.content,
    ...
    inner class MyWebChromeClient : WebChromeClient() {
        ...
        override fun onJsAlert(
            ...
            MaterialAlertDialogBuilder(this@AboutPage, R.style.DialogTheme)
                .setTitle("Perhatian")
                .setMessage(message)
