...
import id.onklas.app.databinding.ProkesChoice2Binding
import id.onklas.app.pages.prokes.ListChoice

class SubchoiceAdapter (
    val onSelected: (ListChoice, Int) -> Unit,
) : ListAdapter<ListChoice, SubchoiceAdapter.subViewholder>(object : DiffUtil.ItemCallback<ListChoice>() {
    ...
    override fun onBindViewHolder(holder: subViewholder, position: Int, payloads: MutableList<Any>) {
...
//            Timber.e("payload $payloads")
    ...
    inner class subViewholder(
        parent: ViewGroup,
        val binding: ProkesChoice2Binding = ProkesChoice2Binding.inflate(
...
//            Timber.e("select")
            onSelected.invoke(item,adapterPosition)
        }
