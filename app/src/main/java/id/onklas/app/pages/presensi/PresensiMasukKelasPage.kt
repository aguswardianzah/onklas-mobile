...
import id.onklas.app.databinding.PresensiMasukKelasPageBinding
import id.onklas.app.di.component
import id.onklas.app.pages.PageDialogFragment
import kotlinx.coroutines.launch
import timber.log.Timber

class PresensiMasukKelasPage(val scheduleId: Int, val onDismiss: () -> Unit) :
    PageDialogFragment() {

    private lateinit var binding: PresensiMasukKelasPageBinding
    ...
    override fun onCreateView(
        ...
        PresensiMasukKelasPageBinding.inflate(inflater, container, false).also { binding = it }.root
