...
public class ViewMainSlave extends RelativeLayout {
    ...
    public ViewMainSlave(Context context) {
        super(context);
    }

    public ViewMainSlave(Context context, AttributeSet attrs) {
        super(context, attrs);

        a = context.obtainStyledAttributes(attrs, R.styleable.ViewMainSlave, 0, 0);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            viewPartMain = this.findViewById(a.getResourceId(R.styleable.ViewMainSlave_viewPartMain, -1));
            viewPartSlave = this.findViewById(a.getResourceId(R.styleable.ViewMainSlave_viewPartSlave, -1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//            heightSize += viewPartMainHeight;
            heightSize += viewPartMainHeight + viewPartSlaveHeight - viewPartMain.getLineHeight();
